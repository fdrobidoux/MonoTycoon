        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                IEnumerable<string> files1 =
                    Directory.EnumerateFiles(@"D:\3DS Backups\custom badges\Nintendo Consoles\",
                ...
                Console.WriteLine("Remove instances of 'Famicom' from the set...");
                Console.WriteLine("\tCount before: {0}", mediaFiles1.Count.ToString());
                mediaFiles1.RemoveWhere(x => x.ToLower().StartsWith("famicom"));
                Console.WriteLine("\tCount after: {0}", mediaFiles1.Count.ToString());

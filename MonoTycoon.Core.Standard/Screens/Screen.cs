...
namespace MonoTycoon.Screens
{
	...
	public class Screen : DrawableGameComponent
	{
		...
		protected List<Action<IUpdateable>> updateActions { get; set; }
		protected List<Action<IDrawable>> drawActions { get; set; }

		public Screen(Game game) : base(game)
		{
			Components = new GameComponentCollection();
			Translucent = false;
			drawActions = new List<Action<IDrawable>>();
			updateActions = new List<Action<IUpdateable>>();
		}
		...
		public override void Update(GameTime gameTime) 
			=> Update(gameTime, updateActions.ToArray());

		/// <summary>
		/// Update every Enabled Component of this screen.
		/// </summary>
		public virtual void Update(GameTime gameTime, Action<IUpdateable>[] actions = null)
		{
		...
		public override void Draw(GameTime gameTime) 
			=> Draw(gameTime, drawActions.ToArray());

		public virtual void Draw(GameTime gameTime, Action<IDrawable>[] actions = null)
		{
			// Major credits to Nils Dijk:
